package xingkong.us.expandablerecycleradapter.adapter;
...
import xingkong.us.expandablerecycleradapter.viewholder.AdapterItemUtil;
import xingkong.us.expandablerecycleradapter.viewholder.BaseAdapterItem;
...
public abstract class BaseExpandableAdapter extends RecyclerView.Adapter implements AbstractExpandableAdapterItem.ParentListItemExpandCollapseListener {
    ...
    public void reUpdateData(@NonNull List data) {
     ...
     * @param data items
     */
    public void updateAllData(@NonNull List data) {
        if (data != null && !data.isEmpty()) {
            mDataList = data;
            checkDefaultExpand();
            notifyDataSetChanged();
